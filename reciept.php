...
$db = mysqli_select_db($con, "cinema_db");
						...
						<tr>
							<td class="title">
								<div class="footer-brand">
									<h1 class="footer-heading"> Cinema</h1>
								</div>
							</td>
							<td>
    ...
    // Save QR code as PNG
    QRcode::png($qrText, "verify.png", "L", 5, 5);
...
?>
	...
	<div style="max-width: 300px; margin:auto; padding: 30px;">
		...
		<a type="button" class="btn btn-success" href='http://localhost/php/xceller%20project/movie_ticket_booking_system_php-main/'>Home-Page</a>
	</div>
...
if (isset($_GET['id'])) {
    ...
    echo "<p>Your Ticket has been booked. Order ID: <strong>$orderId</strong></p>";
}
?>
