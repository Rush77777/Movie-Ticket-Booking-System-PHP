        ...
        <div class="booking-panel-section booking-panel-section4">
            ...
            <div class="booking-form-container">
                <form action="verify.php" method="POST">
                    ...
                    <?php
                    $daysToShow = 7; // how many future days you want
                    $formatForValue = "d-m"; // e.g., 25-07
                    $formatForDisplay = "F j, Y"; // e.g., July 25, 2025

                    for ($i = 0; $i < $daysToShow; $i++) {
                       $date = strtotime("+$i day");
                      $value = date($formatForValue, $date);
                        $display = date($formatForDisplay, $date);
